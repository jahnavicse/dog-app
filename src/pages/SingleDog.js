        ...
        >
          ...
          <article>
            ...
            <ul className="text-sm text-slate-400 leading-loose lg:text-base lg:leading-relaxed">
              <DogAttribute label="Bred For" value={item.bred_for} />
              <DogAttribute label="Height" value={`${item.height.metric} cm`} />
              <DogAttribute label="Weight" value={`${item.weight.metric} kgs`} />
              <DogAttribute label="Breed Group" value={item.breed_group} />
              <DogAttribute label="Lifespan" value={item.life_span} />
              <DogAttribute label="Temperament" value={item.temperament} />
            </ul>
...
function DogAttribute({ label, value }) {
  return (
    <li>
      <span className="font-bold text-slate-200">{label}:</span> {value}
    </li>
  );
}
